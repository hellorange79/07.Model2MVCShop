...
<form name="detailForm" action="/getPurchase.do?tran_no=${purchase.getTranNo()}" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<c:if test="${purchase.getPaymentOption().trim() eq '1'}">현금구매</c:if>
			<c:if test="${purchase.getPaymentOption().trim() eq '2'}">신용구매</c:if>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
